...
class FormPageLocators:
    ...
    GENDER = ("xpath", f"//div[contains(@class, 'custom-radio')]/label[@for='gender-radio-{random.randint(1, 3)}']")
    DATE_OF_BIRTH = ("xpath", "//input[@id='dateOfBirthInput']")
    SUBJECT = ("xpath", "//input[@id='subjectsInput']")
    HOBBIES = ("xpath", f"//div[contains(@class, 'custom-checkbox')]/label[@for='hobbies-checkbox-{random.randint(1, 3)}']")
